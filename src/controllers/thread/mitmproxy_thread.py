...
class MitmProxyThread(QThread):
    ...
    def __init__(self, listen_port=None, command=None):
        ...
        # 使用绝对路径
        self.script_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),
                                      "controllers", "network", "mitmproxy_packet_capture.py")
        print(f"Script path: {self.script_path}")  # 添加调试输出
