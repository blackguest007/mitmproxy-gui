...
使用方法:
    mitmdump -p 8888 -s aes_cbc.py --mode upstream:http://127.0.0.1:8080 --ssl-insecure field=data key=1234567890123456 iv=1234567890123456
    ...
    def request(self, flow: http.HTTPFlow) -> None:
        ...
        try:
            ...
            if modified:
                ...
                logging.info(f"解密后的请求数据: {flow.request.content.decode('utf-8')}")
...
# 注册插件
addons = [AesCbcDecryptInterceptor(decryption_fields, key, iv)] 