...
使用方法:
    mitmdump -p 8888 -s des_cbc.py --ssl-insecure field=password key=12345678 iv=12345678
    mitmdump -p 8888 -s des_cbc.py --ssl-insecure field=password,username key=12345678 iv=12345678
...
# 注册插件
addons = [DesEncryptInterceptor(encryption_fields, key, iv)] 