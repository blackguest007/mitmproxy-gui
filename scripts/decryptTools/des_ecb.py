...
class DesEcbDecryptInterceptor(BaseInterceptor):
    """DES-ECB 解密拦截器"""
    ...
    def __init__(self):
        ...
        # 获取DES配置
        self.key = self._get_des_config()

    def _get_des_config(self) -> bytes:
        """获取DES配置"""
        key = None
        for arg in sys.argv:
    ...
    def decrypt_value(self, value: str, url: str, field: str, full_json: Dict[str, Any] = None, form_data: str = "") -> str:
        ...
        try:
            ...
            try:
                ...
                self.logger.log(None, f"DES-ECB解密错误: {str(e)}")
                return value
...
# 创建拦截器实例
interceptor = DesEcbDecryptInterceptor()
